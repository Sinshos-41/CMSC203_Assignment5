 ...
 * Description: This class provides a JavaFX-based graphical user interface for interacting with 
 * Disney World Retail District 5 retail sales data. Users can load sales data from a file, view store and category 
 * sales in a table, calculate holiday bonuses based on performance, and export the data to a new file.
 * Due: 04/08/2025
